...
const PRODUCTS = [
  ...
  },
  {
    ...
    image: "/images/clim 3.jpg",
    specs: ["Intégration totale", "Bruit ultra-faible", "Multi-zones possible"],
    brands: ["Hisense"],
  },
  {
    id: "climatiseur-portable",
    title: "Climatiseurs Mobiles",
    category: "Climatisation",
    description: "Solutions mobiles pour les espaces sans installation fixe. Flexibilité et praticité sans travaux.",
    image: "/images/clim 5.jpg",
    specs: ["Sans installation", "Mobilité totale", "Installation immédiate"],
    brands: ["Roch", "Nagu"],
  },
  {
    id: "frigot",
